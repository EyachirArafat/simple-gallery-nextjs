...
import { Heart, Share2, Eye, Play, X, ChevronLeft, ChevronRight } from "lucide-react";
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                    {isVideo && isYouTube ? (
                        <div className="w-full h-full bg-gray-900 flex items-center justify-center">
                            <Image
                                src={`https://img.youtube.com/vi/${src.split("/embed/")[1]?.split("?")[0]}/maxresdefault.jpg`}
                                alt={title}
                                fill
                    ...
                    <button
                        ...
                        className={`absolute top-3 right-3 p-2 rounded-lg backdrop-blur-sm transition-all duration-200 ${favorite
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-400">
                            <button
                                onClick={handleLike}
                                className={`flex items-center gap-1.5 hover:text-purple-400 transition-colors ${liked ? "text-purple-400" : ""
                                    }`}
                            >
