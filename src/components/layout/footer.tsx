...
export const Footer = () => {
  return (
    <footer className="border-t border-gray-800/50 bg-gray-900/50 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Your ultimate destination for stunning photos and videos.
              Discover, upload, and share amazing media content.
            </p>
            {/* Social Links */}
