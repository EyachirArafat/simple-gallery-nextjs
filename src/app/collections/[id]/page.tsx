...
import { ArrowLeft, Folder, Image, Edit2, Trash2, Plus, MoreVertical } from "lucide-react";
...
const collectionsData = {
    "1": {
        ...
        description: "Beautiful landscapes and nature shots from around the world. This collection features stunning sunsets, mountains, forests, and wildlife.",
        ...
        <div className="min-h-screen py-8 px-4">
            <div className="container max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-semibold text-white">Media in this collection</h2>
