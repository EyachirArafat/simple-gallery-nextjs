...
import { Grid3X3, Image, Video, Mountain, Building, User, Sparkles, Leaf, Camera } from "lucide-react";
                    ...
                    {categories.map((category) => {
                        ...
                        return (
                            <Link
                                ...
                                className={`group relative p-6 rounded-2xl bg-gradient-to-br ${category.bgColor} border ${category.borderColor} hover:border-opacity-100 transition-all duration-300 hover:-translate-y-1 overflow-hidden`}
                            >
                                {/* Background Glow */}
                                <div className={`absolute top-0 right-0 w-32 h-32 rounded-full bg-gradient-to-br ${category.color} opacity-20 blur-2xl group-hover:opacity-30 transition-opacity`} />
